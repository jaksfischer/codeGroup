            ...
            <div class="row">
                ...
                <div class="col-4 d-flex align-items-center">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="isGoalkeeper" id="isGoalkeeper1" value="1">
                        <label class="form-check-label" for="isGoalkeeper1">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="isGoalkeeper" id="isGoalkeeper2" value="0">
                ...
                <div class="col-4 d-flex align-items-center">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="presence" id="presence2" value="0">
